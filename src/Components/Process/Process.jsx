...
function Process() {
  return (
    <section className=' work-process ptb-120 mt-5 mb-5'>
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-md-10 col-lg-6">
            <div className="text-center">
              <h4 className='text-primary h5'>Process</h4>
              <h2>We Follow Our Work Process</h2>
              <p className='text-muted'>Conveniently mesh cooperative services via
                 magnetic outsourcing. Dynamically grow functionalized value whereas accurate e-commerce.</p>
            </div>
          </div>
        </div>
